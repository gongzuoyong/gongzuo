...
<div class="main-div">
<!-- /zj/index.php/Article/ArticleCat/add:当前方法 -->
    <form method="POST" action="/zj/index.php/Article/ArticleCat/add">
        <table cellspacing="1" cellpadding="3" width="100%">
                ...
                <td>
                	                		<input checked="checked" type="radio" name="is_help" maxlength="60" value="是" />是                	                		<input  type="radio" name="is_help" maxlength="60" value="否" />否                	                                        <span class="require-field">*</span>
                                    </td>
            </tr>
                        <tr>
