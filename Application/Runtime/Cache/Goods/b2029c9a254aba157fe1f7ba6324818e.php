...
<div class="main-div">
<!-- /zj/index.php/Goods/Brand/add:当前方法 -->
    <form method="POST" action="/zj/index.php/Goods/Brand/add" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
                ...
                <td>
                	                   		<input type="text" name="brand_url" maxlength="60" value="" />
                                                            <span class="require-field">*</span>
                                    </td>
            </tr>
                        <tr>
