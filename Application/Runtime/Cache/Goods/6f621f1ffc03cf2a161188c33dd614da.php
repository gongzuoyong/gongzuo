...
<body>
<?php $type_id = I('get.type_id'); ?>
<h1>
    <span class="action-span"><a href="/zj/index.php/Goods/Attribute/add/type_id/<?php echo $type_id; ?>">添加</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 列表 </span>
    <div style="clear:both"></div>
</h1>
当前类型：
<select onchange="location.href='/zj/index.php/Goods/Attribute/lst/type_id/'+this.value;">
...
<form method="post" action="/zj/index.php/Goods/Attribute/bdel" name="listForm">
            ...
            <?php foreach ($data as $k => $v): ?>            <tr>
                <td align="center">
               		<input name="delid[]" class="selall" type="checkbox" value="<?php echo $v['id']; ?>" />
                                ...
                                <td align="center"><?php echo $v['attr_values']; ?></td>
                                <td align="center">
                <a href="/zj/index.php/Goods/Attribute/save/id/<?php echo $v['id']; ?>/type_id/<?php echo $type_id; ?>" title="编辑">编辑</a>
                <a onclick="return confirm('确定要删除吗？');" href="/zj/index.php/Goods/Attribute/del/id/<?php echo $v['id']; ?>/type_id/<?php echo $type_id; ?>" title="编辑">移除</a> 
                </td>
            </tr>
           	<?php endforeach; ?>            <tr>
