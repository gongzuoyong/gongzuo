...
<body>
<h1>
    <span class="action-span"><a href="/zj/index.php/Ad/AdPos/add">添加</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 列表 </span>
    <div style="clear:both"></div>
</h1>
<form method="post" action="/zj/index.php/Ad/AdPos/bdel" name="listForm">
            ...
            <?php foreach ($data as $k => $v): ?>            <tr>
                <td align="center">
               		<input name="delid[]" class="selall" type="checkbox" value="<?php echo $v['id']; ?>" />
                                ...
                                <td align="center"><?php echo $v['pos_name']; ?></td>
                                <td align="center"><?php echo $v['pos_width']; ?></td>
                                <td align="center"><?php echo $v['pos_height']; ?></td>
                                <td align="center">
                <a href="/zj/index.php/Ad/AdPos/save/id/<?php echo $v['id']; ?>" title="编辑">编辑</a>
                <a onclick="return confirm('确定要删除吗？');" href="/zj/index.php/Ad/AdPos/del/id/<?php echo $v['id']; ?>" title="编辑">移除</a> 
                </td>
            </tr>
           	<?php endforeach; ?>            <tr>
