...
<body>
<h1>
    <span class="action-span"><a href="/zj/index.php/Ad/AdPos/lst">列表</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 修改 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
<!-- /zj/index.php/Ad/AdPos/save/id/1:当前方法 -->
    <form method="POST" action="/zj/index.php/Ad/AdPos/save/id/1">
