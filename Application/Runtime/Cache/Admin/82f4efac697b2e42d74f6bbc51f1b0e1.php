...
<body>
<h1>
    <span class="action-span"><a href="/zj/index.php/Admin/Admin/lst">管理员列表</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 添加管理员 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
<!-- /zj/index.php/Admin/Admin/add:当前方法 -->
    <form method="POST" action="/zj/index.php/Admin/Admin/add">
