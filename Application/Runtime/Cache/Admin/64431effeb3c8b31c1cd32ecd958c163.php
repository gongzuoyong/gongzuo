...
<body>
<h1>
    <span class="action-span"><a href="/zj/index.php/Admin/Role/add">添加</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 列表 </span>
    <div style="clear:both"></div>
</h1>
<form method="post" action="/zj/index.php/Admin/Role/bdel" name="listForm">
            ...
            <?php foreach ($data as $k => $v): ?>            <tr>
                ...
                <?php if($v['id'] > 1): ?>
               	...
               	<?php endif; ?>
                                ...
                                <td align="center"><?php echo $v['pri_id_list'] == '*' ? '所有权限' : $v['pri_name']; ?></td>
                                <td align="center">
                <?php if($v['id'] > 1): ?>
                <a href="/zj/index.php/Admin/Role/save/id/<?php echo $v['id']; ?>" title="编辑">编辑</a>
                <a onclick="return confirm('确定要删除吗？');" href="/zj/index.php/Admin/Role/del/id/<?php echo $v['id']; ?>" title="编辑">移除</a> 
                <?php endif; ?>
                </td>
            </tr>
           	<?php endforeach; ?>            <tr>
